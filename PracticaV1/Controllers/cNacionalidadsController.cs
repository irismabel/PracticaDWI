...
namespace PracticaV1.Controllers
{
    public class cNacionalidadsController : Controller
    {
        ...
        public cNacionalidadsController(HotelimlcContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idNaciobnalidad,pais,nacionalidad")] cNacionalidad cNacionalidad)
        {
