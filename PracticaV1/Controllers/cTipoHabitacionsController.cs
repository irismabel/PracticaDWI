...
namespace PracticaV1.Controllers
{
    ...
    {
        private readonly HotelimlcContext _context;

        public cTipoHabitacionsController(HotelimlcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("idTipo,nombre,descripcion")] cTipoHabitacions cTipoHabitacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idTipo,nombre,descripcion")] cTipoHabitacions cTipoHabitacion)
        {
